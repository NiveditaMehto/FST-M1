...
public class Activity2 {
    ...
    public void getUserInfo() {
        ...
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "doggie") // Pass request body from file
        ...
        response.then().body("username", equalTo("doggie"));
    ...
    public void deleteUser() throws IOException {
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "doggie") // Add path parameter
                        .when().delete(BaseURI + "/{username}"); // Send delete request

        // Assertion
        response.then().body("code", equalTo(200));
        response.then().body("message", equalTo("doggie"));
    }
}